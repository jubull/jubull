...
include_once ('com/alibaba/trade/param/AlibabaTradeRefundOpLogisticsTraceDetail.class.php');

class AlibabaTradeRefundOpLogisticsTraceServiceResult {
    ...
    */
    ...
    /**
     * 设置     
     * @param AlibabaTradeRefundOpLogisticsTraceDetail $result     
          
     * 此参数必填     */
    public function setResult(AlibabaTradeRefundOpLogisticsTraceDetail $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new AlibabaTradeRefundOpLogisticsTraceDetail();
