...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeResultOpProcessTemplateResultModel.class.php');

class AlibabaTradeQueryTradeTypesOfOfferResult {
    ...
    */
    ...
    /**
     * 设置支持的交易类型     
     * @param AlibabaOpenplatformTradeResultOpProcessTemplateResultModel $result     
          
     * 此参数必填     */
    public function setResult(AlibabaOpenplatformTradeResultOpProcessTemplateResultModel $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new AlibabaOpenplatformTradeResultOpProcessTemplateResultModel();
