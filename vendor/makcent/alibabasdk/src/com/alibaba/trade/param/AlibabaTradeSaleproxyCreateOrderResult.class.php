...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeResultTradeCreateGeneralOrderResult.class.php');

class AlibabaTradeSaleproxyCreateOrderResult {
