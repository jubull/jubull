...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeResultOpMarketingMixConfigModel.class.php');

class AlibabaTradeOpQueryMarketingMixConfigResult {
    ...
    */
    ...
    /**
     * 设置     
     * @param AlibabaOpenplatformTradeResultOpMarketingMixConfigModel $result     
          
     * 此参数必填     */
    public function setResult(AlibabaOpenplatformTradeResultOpMarketingMixConfigModel $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new AlibabaOpenplatformTradeResultOpMarketingMixConfigModel();
