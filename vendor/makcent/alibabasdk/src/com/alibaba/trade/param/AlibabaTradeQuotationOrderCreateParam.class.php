...
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeBizMakeSingleOrderGroup.class.php');
include_once ('com/alibaba/trade/param/AlibabaOpenplatformTradeQuotationIdParam.class.php');
