...
include_once ('com/alibaba/product/param/AlibabaProductProductOperateResult.class.php');
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$resultResult=$arrayResult['result'];
    			...
    			$this->subErrorCode = $arrayResult['subErrorCode'];
    			}
    		    	    			    		    			if (array_key_exists ( "subErrorMessage", $this->arrayResult )) {
    			$this->subErrorMessage = $arrayResult['subErrorMessage'];
    			}
    		    	    		}
