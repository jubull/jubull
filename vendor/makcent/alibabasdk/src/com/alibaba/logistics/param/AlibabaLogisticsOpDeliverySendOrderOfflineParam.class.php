...
include_once ('com/alibaba/logistics/param/AlibabaLogisticsOpReceiveContacter.class.php');
...
class AlibabaLogisticsOpDeliverySendOrderOfflineParam {
    ...
    */
    ...
    public function setGmtSend( $gmtSend) {
        ...
        /**
    * @return JSON字符串，cpCode 为物流公司code，对应物流公司信息获取接口的companyNo（非数字Id）; logisticsCpName:物流公司名称，对应物流公司信息获取接口的companyName； mailNo：运单号； 可以通过获取物流公司借口查询到数据。
    */
    ...
    /**
     * 设置JSON字符串，cpCode 为物流公司code，对应物流公司信息获取接口的companyNo（非数字Id）; logisticsCpName:物流公司名称，对应物流公司信息获取接口的companyName； mailNo：运单号； 可以通过获取物流公司借口查询到数据。     
